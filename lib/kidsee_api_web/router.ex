defmodule KidseeApiWeb.Router do
  ...
  scope "/api", KidseeApiWeb do
    ...
    resources "/discovery-assignments", DiscoveryAssignmentController, only: [:index, :create, :update, :show, :delete]
    ...
    resources "/roles", RoleController, only: [:index, :create, :update, :show, :delete]
    ...
    resources "/theme-locations", ThemeLocationController, only: [:index, :create, :update, :show, :delete]
